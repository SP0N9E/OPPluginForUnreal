...
UENUM(BlueprintType)
enum class ElementToRender : uint8 {
	Skeleton,
	Background,
	AddKeypoints,
	AddPAFs,
...
UENUM(BlueprintType)
enum class DisplayMode : uint8 { // original: uint16
